...
class CustomerRegister : AppCompatActivity() , View.OnClickListener{
    ...
    private lateinit var regCollection: CollectionReference
...
//        regCollection = firestore.collection("responses")
//
