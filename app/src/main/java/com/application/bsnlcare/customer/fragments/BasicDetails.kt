    ...
    override fun onCreateView(
        ...
        nextButton.setOnClickListener() {
            ...
            if (selectId == -1) {
                ...
                CustomerDashboard.gender = rB.text.toString()
                CustomerDashboard.nameOfCustomer = nameEdtTxt.text.toString()
                CustomerDashboard.emailOfCustomer = emailEdtTxt.text.toString()
                CustomerDashboard.registrationNumber = regEdtTxt.text.toString()

                // change fragment
                val recommended = Recommended()
                requireActivity().supportFragmentManager.beginTransaction()
                    .replace(R.id.fragment_container, recommended).commit()
